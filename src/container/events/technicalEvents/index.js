...
import tech_event_left from "../../../assets/images/event/tech-event-left-image.png";
import Aos from "aos";
          ...
          <div className="row">
            <div className="col-lg-4">
              <div className="left-image wow fadeIn">
                <img src={tech_event_left} alt="person graphic" />
              </div>
            </div>
          </div>
          <div className="right--text pt69 text-end pr90">
        ...
        <div className="auto-container">
          <div className="main_div">
            <div className="event-row">
              {eventData[0]?.events?.map((z, index) => {
                return (
                  <>
                    <div
                      className="inner-box"
                    ...
                    >
                      <figure className="image-box">
                        <div>
                          <img
                            src={z.image}
                            // src="https://ychef.files.bbci.co.uk/1280x720/p03xwtrv.jpg"
                            alt=""
                          />
                        </div>
                      </figure>
